...
For example, the agent's first-person view prevents them from seeing zombies behind them and reacting, whereas a bird's-eye view would provide the agent with the positions of every zombie.
This feature of Minecraft places a constraint on performance, but also approximates real training applications which depend solely on visual input, such as autonomous vehicles.
...
\begin{subfigure}{.25\textwidth}
  \centering
  \includegraphics[scale=0.2]{./kills.png}
  \caption{1a}
  \label{fig:sfig1}
\end{subfigure}%
\begin{subfigure}{.25\textwidth}
  \centering
  \includegraphics[scale=0.2]{./reward.png}
  \caption{1b}
  \label{fig:sfig2}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}{.25\textwidth}
  \centering
  \includegraphics[scale=0.2]{./time.png}
  \caption{1c}
  \label{fig:sfig3}
\end{subfigure}
\begin{subfigure}{.25\textwidth}
  \centering
  \includegraphics[scale=0.2]{./Qvalue.png}
  \caption{1d}
  \label{fig:sfig3}
\end{subfigure}
\label{fig:fig}
