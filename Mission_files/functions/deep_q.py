...
class DeepLearner:
    ...
    def __init__(self):
        s, readout, h_fc1  = self.createNet();
        self.agent = DeepAgent()
        self.a, self.y, self.train_step, self.D, self.s_t =  self.initNetwork(s,readout,sess)
    ...
    def initNetwork(self,s, readout, sess):
